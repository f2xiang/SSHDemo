...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#btnEp").click(function(){
			//对表单中所有的输入框进行校验 如果都校验通过 返回true 一个不通过 false 
			var v = $("#editPasswordFrom").form("validate");
			if(v){
				//判断两次输入是否一致
				...
				if(v1 == v2){
					...
					$.messager.alert("提示信息","两次输入的密码不一致，请重新输入","warning");
				}
			}
	...
	// 版权信息
	function showAbout(){
		$.messager.alert("宅急送 v1.0","管理员邮箱: fengxiang1209@foxmail.com");
	}
</script>
</head>
	                ...
	                <table cellpadding=3>
	                    <tr>
	                        ...
	                        <td><input id="txtNewPass" type="Password" class="txt01 easyui-validatebox" 
	                                required="true"   data-options="validType:'length[3,8]'" /></td>
	                    </tr>
	                    <tr>
	                        <td>确认密码：</td>
