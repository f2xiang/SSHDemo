		...
		<div class="span24">
			<div class="step step1">
				...
				<table>
					<tbody><tr>
						...
						<tr>
							...
							<td>
								<a href="${pageContext.request.contextPath}/cart_delCart.action?pid=<s:property value="#cartItem.product.pid" />" class="delete">删除</a>
							</td>
						</tr>
						</s:iterator>
				</tbody></table>
				...
				<div class="bottom">
					...
					<a href="${pageContext.request.contextPath}/order_addOrder.action" id="submit" class="submit">提交订单</a>
				</div>
		</div>
		</s:if>
		<s:else>
			<div class="span24">
				<div class="step step1">
				<span style="font-size: 20px">你的购物车空空如也  点击         <a href="${pageContext.request.contextPath}/index.action" style="color: blue;">这里</a>前去购物</span>
				</div>
			</div>
		</s:else>
	</div>
