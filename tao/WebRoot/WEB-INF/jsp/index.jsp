		...
		<div class="span24">
			<div id="hotProduct" class="hotProduct clearfix">
				...
				<ul class="tabContent" style="display: block;">
					<s:iterator value="hList" var="hot">
						<li>
							<s:a namespace="/" action="product_findByPid" target="_blank">
								<s:param name="pid" value="#hot.pid"></s:param>
					...
					<ul class="tab">
					 ...
					 <ul class="tabContent" style="display: block;">
						<s:iterator value="nList" var="n">
							<li>
								<s:a namespace="/" action="product_findByPid" target="_blank">
									<s:param name="pid" value="#n.pid"></s:param>
